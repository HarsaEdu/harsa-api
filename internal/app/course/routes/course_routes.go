...
func (courseRoutes *CourseRoutesImpl) CourseWeb(apiGroup *echo.Group) *echo.Group {
	...
	coursesGroup.POST("", courseRoutes.CourseHandler.Create, middleware.AdminMiddleware)
	coursesGroup.POST("/my-course", courseRoutes.CourseHandler.CreateIntructure, middleware.InstructorMiddleware)
	...
	coursesGroup.PUT("/:id", courseRoutes.CourseHandler.Update, middleware.AdminMiddleware)
	coursesGroup.PUT("/my-course/:id", courseRoutes.CourseHandler.UpdateIntructure, middleware.InstructorMiddleware)
