...
// SendRecommendationsForInstructor provides a mock function with given fields: ctx
func (_m *RecommendationsHandler) SendRecommendationsForInstructor(ctx echo.Context) error {
	ret := _m.Called(ctx)
